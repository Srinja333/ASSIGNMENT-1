...
<div>
	...
	<div style="width:80%;float:left"><center><h1 style="margin-top:25px";><b>Dr. Apj Abdul Kalam  public school</h1></center></div>
                        ...
                        <div class="card-body">
                            <form name="my-form" onsubmit="return validform()" action="addNewStudent.jsp" method="post">
                                <div class="form-group row">
                                    <label for="full_name" class="col-md-4 col-form-label text-md-right">class Name</label>
                                    <div class="col-md-6">
                                ...
                                <div class="form-group row">
                                    <label for="email_address" class="col-md-4 col-form-label text-md-right">section Name</label>
                                    <div class="col-md-6">
